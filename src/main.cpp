...
Robot * robot1 = new Robot(100,8); // ref a cpp class in main

enum mgos_app_init_result mgos_app_init(void) {
  hiYou("John Steven"); // ref to a cpp function, work well
  printf("\n%d\n", robot1->getSum()); // ref to a cpp class method, work well
  printf("\n%d\n", getSum2()); // ref to a wrapper func of a cpp class method, work well
